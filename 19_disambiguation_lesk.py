...
def lesk_algorithm(word, sentence):
    ...
    for sense in synsets:
        #Adds the lemma names (words that are synonyms for the target word in this sense)
        # to the signature set. This helps in expanding the set of words representing the sense.
